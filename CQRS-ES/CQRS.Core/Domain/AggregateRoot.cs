...
public abstract class AggregateRoot
{
    ...
    {
        // this will give us a type of concrete aggregate when we inherit this aggregare root
        // we are using a reflection, apply method can be only used in concrete class
